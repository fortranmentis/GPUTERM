...
- **최대 4개의 나란한 터미널 셀** — 포커스된 세션의 새 셸을 분할하거나 다른 저장 세션을 옆에 추가하며, 셀을 클릭하면 배치를 유지한 채 SFTP와 텔레메트리 대상이 전환
...
3. **터미널 분할** — 열 나누기 버튼으로 포커스된 세션의 새 셸을 열거나, **+** 버튼으로 다른 저장 세션을 옆에 추가합니다.
...
- 최대 4개 셀을 나란히 표시할 수 있으며, 서로 다른 세션을 섞으면 각 셀에 프로필 이름이 표시됩니다.
